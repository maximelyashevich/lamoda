                        ...
                        return (
                            <div className="cart__item" key={el.id}>
                                ...
                                <div className="cart__item-right">
                                    ...
                                    <div>
                                        <img style={{ width: '26.25px', height: '30px' }} src='https://s1.iconbird.com/ico/2013/9/452/w448h5121380477116trash.png' alt='trash' className="cart__item-icon" onClick={() => { dispatch(removeFromCart(el)) }} />
                                    </div>
                                </div>
                            </div>
                        )
